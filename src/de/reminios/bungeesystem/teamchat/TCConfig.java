...
public class TCConfig {
    ...
    public static void setup () {
        file = new File(BungeeSystem.plugin.getDataFolder(), "teamchat.yml");
        ...
        if(!(contains("Messages.Prefix"))) {
            ...
            set("Messages.logout", "%prefix%&7Teamchat erfolgreich deaktiviert.");
            set("Messages.logout1", "%prefix%&7Du musst zuerst den Teamchat aktivieren.");
            set("Messages.login", "%prefix%&7Teamchat erfolgreich aktiviert.");
            set("Messages.reload", "%prefix%&7Config erfolgreich neu geladen.");
            set("Messages.tc", "%prefix%&e%name% &8» &7%msg%");
            set("Messages.Help", Arrays.asList("TeamChat-Hilfe:", "- /tc toggle", "- /tc <Nachricht>"));
