...
public class TimeConfig {
    ...
    public static void setup () {
        file = new File(BungeeSystem.plugin.getDataFolder(), "onlinezeit.yml");
        ...
        if(!(contains("Messages.Prefix"))) {
            set("Messages.Prefix", "&9[&6OnlineTime&9] &7");
            ...
            set("Messages.OT", "%prefix%&7Deine Onlinezeit beträgt &e%time% &7Stunden.");
            set("Messages.OT1", "%prefix%&7Die Onlinezeit von &e%name% &7beträgt &e%time%&7.");
        }
    }
